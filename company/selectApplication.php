                ...
                <div class="card shadow mb-4">
                    <!-- User Details Table -->
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            <h6 class="m-0 font-weight-bold text-primary">select application page </h6>
                         </div>
                        ...
                        <div class="card-body">                                
                                ...
                                <?php
                                      include("..\database\connect.php");                                              
                                        ...
                                        ON tbl_job.job_id = tbl_job_application.job_id WHERE tbl_job.company_id =$loggedin_id and status=1";
